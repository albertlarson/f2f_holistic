...
for IDX,X in enumerate(configs):
    ...
    if IDX == 0:
        ...
        df.to_pickle('../../data/results/pickles/fin-yukon.pkl')
    else:
        df = pd.read_pickle('../../data/results/pickles/fin-yukon.pkl')
        df1 = pd.DataFrame.from_dict(parms)
        df = pd.concat([df,df1],ignore_index=True)
        df.to_pickle('../../data/results/pickles/fin-yukon.pkl')
    torch.save(model.state_dict(),f'../../data/results/models/yukon/{IDX}.ptm')
